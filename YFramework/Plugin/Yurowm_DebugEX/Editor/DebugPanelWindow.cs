...
public class DebugPanelWindow : EditorWindow {
	...
	void DrawToolbar ()
	{
		...
		if (GUILayout.Button ("Write To Log File", EditorStyles.toolbarButton, GUILayout.Width (150))) {
			DebugPanel.WriteEventToLogFile();
		}
		if (GUILayout.Button ("Write To Log Error File", EditorStyles.toolbarButton, GUILayout.Width (170))) {
			DebugPanel.WriteEventToLogErrorFile();
		}
	...
	void DrawFields ()
	{
		...
		GUILayout.Space(20);
		EditorGUILayout.LabelField("Title", fieldTextStyle, GUILayout.Width(250));
    ...
    [MenuItem ("YFramework/Debug Panel")]
